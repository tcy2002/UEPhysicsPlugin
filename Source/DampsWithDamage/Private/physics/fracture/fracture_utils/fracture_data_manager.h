...
/**
 * The mesh manager class, which is used to manage the
 ...
 *   several triangles;
 * - each vertex has its own normal, but all the triangles of a
 *   face share the same normal;
 * - each vertex of a face must be in the same plane, and the
