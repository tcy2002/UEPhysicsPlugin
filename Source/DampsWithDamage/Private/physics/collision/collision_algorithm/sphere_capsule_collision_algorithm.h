...
class SphereCapsuleCollisionAlgorithm : public CollisionAlgorithm {
public:
    ...
    static bool getClosestPoints(pe_physics_shape::SphereShape* shape_a, pe_physics_shape::CapsuleShape* shape_b,
