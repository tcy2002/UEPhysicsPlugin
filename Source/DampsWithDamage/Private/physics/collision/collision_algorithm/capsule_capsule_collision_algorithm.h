...
class CapsuleCapsuleCollisionAlgorithm : public CollisionAlgorithm {
public:
    ...
    static bool getClosestPoints(pe_physics_shape::CapsuleShape* shape_a, pe_physics_shape::CapsuleShape* shape_b,
