...
class RigidBody {
    ...
    COMMON_MEMBER_PTR_GET(pe_physics_shape::Shape, collision_shape, CollisionShape)
public:
    PE_API void setCollisionShape(pe_physics_shape::Shape* shape);
...
protected:
    pe::Vector3 _last_linear_velocity;
    pe::Vector3 _last_angular_velocity;
...
public:
    ...
    PE_API pe::Vector3 getAvgAngularVelocity2Frames() const;
